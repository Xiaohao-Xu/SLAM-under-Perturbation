...
class SLAM:
    ...
    def run(self, stream):
        ...
        # Call the optimizing method
        if not self.only_tracking:  # This check is equivalent to "dont_run if self.only_tracking else (not dont_run)"
            print('Starting optimizing...')
            self.optimizing(1)
            print('Optimizing done.')

        # Call the multiview filtering method
        if not self.only_tracking:
            print('Starting multiview filtering...')
            self.multiview_filtering(2)
            print('Multiview filtering done.')
        ...
        # Call the meshing method
        # This was originally set to run at the end only once, so we keep that logic
        print('Starting meshing...')
        self.meshing(4)
        print('Meshing done.')

        # Call the visualizing method
