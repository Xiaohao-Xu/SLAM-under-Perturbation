...
EXPANDED_SCRIPT_NAME="run_replica_goslam_mono_img_perturb_dynamic_expand.sh" # The name of the generated script
...
for sc in $SCENES; do
  for sev in 5 3 1; do
    for pt in $(seq 0 17); do  # Now using seq to generate numbers from 0 to 17.
      ...
      CONFIG_PATH="configs/Replica/${sc}_mono.yaml" # The script assumes mono mode configuration.
