...
PD=1  # Perturbation dynamic (0 for static, 1 for dynamic).
EXPANDED_SCRIPT_NAME="run_replica_goslam_rgbd_misalign_dynamic_expand.sh" # The name of the generated script
