...
perturb_dynamic=0
frame_downsample=1
group_name = "Replica_s_hlb"

run_name = f"{scene_name}_{perturb_type}_{perturb_severity}_{perturb_dynamic}_{frame_downsample}_{seed}"

config = dict(
    workdir=f"./experiments_s/{group_name}",
    ...
    eval_every=1000, # Evaluate every nth frame (at end of SLAM)
