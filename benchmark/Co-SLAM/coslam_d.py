...
if __name__ == '__main__':
    ...
    parser.add_argument('--perturb_severity', type=int, default=1,
                        help='')
    parser.add_argument('--perturb_dynamic', type=int, default=1,
                        help='')
    ...
    cfg['data']['exp_name'] = cfg['data']['exp_name'] + "_" + str(args.perturb_type) + "_" +str(args.perturb_severity) + "_" +str(args.perturb_dynamic)
