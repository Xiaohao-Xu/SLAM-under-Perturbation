...
class MatcherParams(ParamGroup):
    def __init__(self, parser):
        ...
        self.LoFTR_ckpt_path = "LoFTR/ckpt/indoor_ds_new.ckpt" # "LoFTR/ckpt/outdoor_ds.ckpt"
        self.LoFTR_temp_bug_fix =  True  # False # set to False when using the old ckpt
        super().__init__(parser, "Matcher Parameters")
