...
def parse_args():
    ...
    parser.add_argument("--path", type=str, help="Folder path of params.npz .")
...
if __name__ == "__main__":
    ...
    params_path = os.path.join(args.path, "params.npz")
    ...
    ply_path = os.path.join(args.path, "splat.ply")
