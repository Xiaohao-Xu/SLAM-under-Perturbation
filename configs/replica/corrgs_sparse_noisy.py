...
config = dict(
    ...
    use_sel_top_corr = False,
    use_half_precision = True,
    use_median_average = False,
    use_restoration = True,
    restoration_bound=0.1,
    workdir=f"/media/hdd/xiaohao/corrgs_official/sparse_noisy/{group_name}",
    run_name=run_name,
    seed=seed,
    ...
    use_wandb=False,
    data=dict(
        basedir="/media/hdd/xiaohao/data/Replica",
